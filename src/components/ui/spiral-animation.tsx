...
class AnimationController {
    ...
    public render() {
        ...
        // Use solid dark color instead of CSS variable (canvas can't parse CSS vars)
        ...
        // Use brand cyan color for stars
    ...
    private drawTrail(t1: number) {
        for (let i = 0; i < this.trailLength; i++) {
            ...
            // Use brand cyan color for trail
...
export function SpiralAnimation({ onEnter }: SpiralAnimationProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-background">
            ...
            >
                <button
                    onClick={onEnter}
                    className="text-xl font-light tracking-[0.3em] uppercase text-[#00eaff]/80 hover:text-[#00eaff] transition-all duration-300 animate-pulse hover:animate-none cursor-pointer bg-transparent border-none outline-none"
                >
                    Enter
                </button>
            </div>
